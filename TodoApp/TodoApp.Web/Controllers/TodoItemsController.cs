...
namespace TodoApp.Web.Controllers
{
    public class TodoItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IsComplete,Description")] TodoItem todoItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IsComplete,Description")] TodoItem todoItem)
        {
            if (id != todoItem.Id)
            {
                return NotFound();
